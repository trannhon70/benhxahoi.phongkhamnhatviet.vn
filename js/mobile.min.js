        ...
        if (window.innerWidth <= 900) {
            ...
            if (imgElements) {
                ...
                for (let i = 0; i < imgElements.length; i++) {
                    ...
                    if (imgElements[i].src.startsWith('https://benhxahoi.phongkhamdakhoanhatviet.vn/ckfinder/userfiles/images/Chat/Gif-chat-smg.gif') == true) {
                        imgElements[i].style.width = '320px';
                        imgElements[i].style.height = '130px';
                        imgElements[i].style.borderRadius = '8px';
                        let divWrapper = document.createElement('p');
                    ...
                    if (imgElements[i].src.startsWith('https://benhxahoi.phongkhamdakhoanhatviet.vn/ckfinder/userfiles/images/Chat/Gif-chat-lau.gif') == true) {
                        imgElements[i].style.width = '320px';
                        imgElements[i].style.height = '130px';
                        imgElements[i].style.borderRadius = '8px';
                        let divWrapper = document.createElement('p');
                ...
                for (let i = 0; i < h2Elements?.length; i++) {
                    ...
                    h2Elements[i].style.background = 'url("https://benhxahoi.phongkhamdakhoanhatviet.vn/images/icons/icon_cong.webp") no-repeat left center';
                ...
                for (let i = 0; i < h3Element.length; i++) {
                    ...
                    h3Element[i].style.background = 'url("https://benhxahoi.phongkhamdakhoanhatviet.vn/images/icons/icon_mui.gif") no-repeat left center';
