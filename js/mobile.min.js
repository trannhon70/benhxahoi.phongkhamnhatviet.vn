function checkWidthMobile() {
    ...
    if (window.innerWidth <= 900) {
        if (header || formChat || experienced_footer || experienced_body_left_center || footer || health || slider) {
            header?.remove();
            formChat?.remove();
        ...
        if (headerMobile || formChat_mobile || experienced_footer_mobile || experienced_body_left_center_mobile  || footer_mobile || health_mobile || banner_km_mobile || health_tintuc_mobile || slider_mobile) {
        ...
        if (headerMobile || formChat_mobile || experienced_footer_mobile || experienced_body_left_center_mobile  || footer_mobile || health_mobile || health_tintuc_mobile || slider_mobile) {
            headerMobile?.remove();
        ...
        if (window.innerWidth <= 900) {
            ...
            if (imgElements) {
                for (let i = 0; i < imgElements.length; i++) {
                    ...
                    // console.log(src);
                    if (src) {
                        if (!src.startsWith('/ckfinder/userfiles/images/Icon')) {
                            // console.log(src);
                            imgElements[i].style.width = '100%';    // Đặt width thành 100%
                            imgElements[i].style.height = '225px';  // Đặt height thành 225px
                        }
                    }
                }
                ...
                for (let i = 0; i < imgElements.length; i++) {
                    ...
                    if (imgElements[i].src.startsWith('https://benhxahoi.phongkhamnhatviet.vn/ckfinder/userfiles/images/Chat/Gif-chat-smg.gif') == true) {
                        imgElements[i].style.width = '320px';
                        imgElements[i].style.height = '130px';
                        imgElements[i].style.borderRadius = '8px';
                        let divWrapper = document.createElement('p');
                    ...
                    if (imgElements[i].src.startsWith('https://benhxahoi.phongkhamnhatviet.vn/ckfinder/userfiles/images/Chat/Gif-chat-lau.gif') == true) {
                        imgElements[i].style.width = '320px';
                        imgElements[i].style.height = '130px';
                        imgElements[i].style.borderRadius = '8px';
                        let divWrapper = document.createElement('p');
                ...
                for (let i = 0; i < h2Elements?.length; i++) {
                    ...
                    h2Elements[i].style.background = 'url("https://benhxahoi.phongkhamnhatviet.vn/images/icons/icon_cong.webp") no-repeat left center';
                ...
                for (let i = 0; i < h3Element.length; i++) {
                    ...
                    h3Element[i].style.background = 'url("https://benhxahoi.phongkhamnhatviet.vn/images/icons/icon_mui.gif") no-repeat left center';
