// let local = 'http://localhost/_nhatvietnew/benhxahoi.phongkhamnhatviet.vn';
let local = 'https://benhxahoi.phongkhamnhatviet.vn';
...
function checkImgMobile() {
    ...
    Array.from(imgElements).forEach(img => {
        ...
        if (img.src.startsWith(`${local}/ckfinder/userfiles/images/Chat`)) {
            // if (img.src.startsWith('http://localhost/ckfinder/userfiles/images/Chat')) { 
