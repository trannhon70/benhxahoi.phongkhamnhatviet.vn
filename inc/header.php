...
// $local = '/benhxahoi.phongkhamnhatviet.vn';
$local ='https://benhxahoi.phongkhamnhatviet.vn'
    ...
    <div id="header" class="container-fluid">
        ...
        <div style="background-color: #209dc3;">
            ...
            <div style="background-color: #209dc3;" class="container header_bottom">
                ...
                <div class="header_bottom_gt"> <a class="header_bottom_gt_a" target="_blank" href="https://benhxahoi.phongkhamnhatviet.vn/phong-kham-da-nhat-viet-phong-kham-da-khoa-uy-tin-tphcm-7.html">Giới thiệu</a></div>
