<section class="appointment" id="appointment_mobile">
    <div id="form-chatMobileform-chatMobile" class="appointment__mobile-form">
        <div class="appointment__mobile-form-body">
            ...
            <div class="appointment__mobile-form-input">
                <input name="ngaysinh" type="number" placeholder="Nhập năm sinh" minlength="4" maxlength="4" min="1900"
                    max="2100">
            </div>
            <div class="appointment__mobile-form-input">
